...
<body>
	...
	<div class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
		<div class="panel panel-primary">
			<div class="panel-heading">
				<center>
					...
					%>
					You are not logged in<br /> <a href="EndUserLogin.jsp"><br>Please Login</a>
					<%
						} else {
					%>
					Welcome
			...
			<div class="panel-body">
				<form action="EndUserResult.jsp" method="POST">
					<br>
					<tr>
						<div class="form-group">
							<label>Select product you want to see reviews for </label> 
							<%
		...
		%> 
						...
						<td><br> <input type="submit" value="Reviews" class="btn btn-primary"></td>
					</tr>
				</form>
			</div>
			<%
